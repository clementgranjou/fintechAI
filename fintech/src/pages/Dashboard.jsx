    ...
    <div className="container h-full grid gap-8 mb-32">
      ...
      <div className="grid gap-4">
        <CardTitle className="font-medium text-sm text-slate-800">
          Prédiction des dépenses sur le mois suivant
        </CardTitle>
        <CardDescription>
          Veillez à avoir les fonds nécessaires pour payer les transactions qui
          ne sont pas encore débités
        </CardDescription>
      ...
      <Card className="bg-slate-50">
        <CardHeader>
          ...
          <CardDescription className="font-semibold text-4xl text-slate-800">
            63%
          </CardDescription>
        </CardHeader>
      ...
      <CardDescription>
        Veillez à avoir les fonds nécessaires pour payer les transactions qui ne
        sont pas encore débités
      </CardDescription>
      <MyPieChart />
    </div>
  );
